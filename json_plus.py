...
def smartcmp(a,b,
    ...
    """
    Smart comparison that can handle complex types.  Used to sort
    dictionaries containing arbitrary types.
    :param a: Comparison el 1
    :param b: Comparison el 2
    :param types: List of types for which we support ground comparison.
    :return: -1, 0, +1
    """
